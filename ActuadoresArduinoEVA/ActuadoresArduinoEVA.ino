//Código de Arduino para mover el EVA y el RAMSES de Sensórica, Robocol (2022). El arduino se comunica por serial con 
//una raspberry que le envía mensajes de control al arduino. 
