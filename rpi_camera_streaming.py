...
# Este es el código para publicar el streaming de la cámara del EVA en una dirección web. 
# Basta con correr en una terminal en la dirección raiz "python3 rpi_camera_streaming.py" y poner la
# dirección http://rpi-address:8000/
...
# - Para más información acerca del código de la cámara y el script para el streaming, se puede visitar el siguiente link:
